...
public class ColorBox extends FlowPane
{
	protected Button colorButton; // click to change color
	protected Random randy;
	//protected static ColorBoxDemo theDemo;
	protected Color color;
	protected static ColorBox lastOne; // the last one you clicked on
	
	// constructor
    public ColorBox( /* ColorBoxDemo td */ )
    {
    ...
    // access
    public static ColorBox getLastOne() { return lastOne; }
